...
exports.handler = async (event) => {
    ...
    try {
            ...
            const response = {
                ...
                headers: {
                    ...
                    "set-cookie": [
                        ...
                        {
                            key: "set-cookie",
                            value: `spa-auth-edge-nonce-hmac=${encodeURIComponent(shared_1.sign(nonce, CONFIG.nonceSigningSecret, CONFIG.nonceLength))}; ${CONFIG.cookieSettings.nonce}`,
                        },
                    ],
        ...
        const loginQueryString = querystring_1.stringify({
            ...
            shared_1.urlSafe.stringify(Buffer.from(JSON.stringify({ nonce: state.nonce, requestedUri })).toString("base64")),
...
function generatePkceVerifier(pkce) {
    ...
    const verifier = {
        pkce,
        pkceHash: shared_1.urlSafe.stringify(crypto_1.createHash("sha256").update(pkce, "utf8").digest("base64")),
    };
